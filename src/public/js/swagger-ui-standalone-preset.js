        ...
        8287(t, e, r) {
          ...
          (Buffer.prototype.slice = function slice(t, e) {
            ...
            (Buffer.prototype.readInt8 = function readInt8(t, e) {
              return (
                (t >>>= 0), e || checkOffset(t, 1, this.length), 128 & this[t] ? -1 * (255 - this[t] + 1) : this[t]
              );
            }),
      ...
      (() => {
          ...
          render() {
            ...
            if (f) {
              ...
              f.forEach((e, r) => {
                ...
                l.push(
                  n.createElement(
                    ...
                    n.createElement(
                      'select',
                      { id: 'select', disabled: u, onChange: this.onUrlSelect, value: f[this.state.selectedIndex].url },
                      t
                    )
                  )
                );
              ...
              (p = this.downloadUrl),
                ...
                l.push(n.createElement(o, { className: 'download-url-button', onClick: this.downloadUrl }, 'Explore'));
            return n.createElement(
              'div',
              { className: 'topbar' },
              n.createElement(
        ...
        var ot = function makeSnippet(t, e) {
            ...
            for (s = 1; s <= e.linesBefore && !(a - s < 0); s++)
              (u = getLine(t.buffer, o[a - s], i[a - s], t.position - (o[a] - o[a - s]), l)),
                (c = rt.repeat(' ', e.indent) + padStart((t.line - s + 1).toString(), f) + ' | ' + u.str + '\n' + c);
            for (
              u = getLine(t.buffer, o[a], i[a], t.position, l),
                c += rt.repeat(' ', e.indent) + padStart((t.line + 1).toString(), f) + ' | ' + u.str + '\n',
        ...
        var st = function Type$1(t, e) {
          if (
            ...
            Object.keys(e).forEach(function (e) {
              if (-1 === it.indexOf(e))
                throw new nt('Unknown option "' + e + '" is met in definition of "' + t + '" YAML type.');
            }),
            (this.options = e),
            (this.tag = t),
            ...
            throw new nt('Unknown kind "' + this.kind + '" is specified for "' + t + '" YAML type.');
        };
        ...
        var _t = new st('tag:yaml.org,2002:int', {
            ...
            predicate: function isInteger(t) {
              return '[object Number]' === Object.prototype.toString.call(t) && t % 1 == 0 && !rt.isNegativeZero(t);
            },
            represent: {
              binary: function (t) {
        ...
        var xt = new st('tag:yaml.org,2002:timestamp', {
          ...
          construct: function constructYamlTimestamp(t) {
            var e,
              ...
              c = 0,
              f = null;
            if ((null === (e = wt.exec(t)) && (e = It.exec(t)), null === e)) throw new Error('Date resolve error');
        ...
        var Kt = {
          ...
          TAG: function handleTagDirective(t, e, r) {
            ...
            2 !== r.length && throwError(t, 'TAG directive accepts exactly two arguments'),
              (n = r[0]),
              (o = r[1]),
              Ut.test(n) || throwError(t, 'ill-formed tag handle (first argument) of the TAG directive'),
              Tt.call(t.tagMap, n) && throwError(t, 'there is a previously declared suffix for "' + n + '" tag handle'),
              Dt.test(o) || throwError(t, 'ill-formed tag prefix (second argument) of the TAG directive');
            try {
        ...
        function mergeMappings(t, e, r, n) {
          var o, i, a, s;
          for (
            rt.isObject(r) || throwError(t, 'cannot merge mappings; the provided source object is unacceptable'),
              a = 0,
        ...
        function composeNode(t, e, r, n, o) {
          ...
          if (
                    ...
                    (function readDoubleQuotedScalar(t, e) {
                      ...
                      : !(function readAlias(t) {
                          ...
                          return (
                            ...
                            Tt.call(t.anchorMap, r) || throwError(t, 'unidentified alias "' + r + '"'),
            ...
            if (Tt.call(t.typeMap[t.kind || 'fallback'], t.tag)) l = t.typeMap[t.kind || 'fallback'][t.tag];
            else
        ...
        function readDocument(t) {
          ...
          for (
            ...
            0 !== o && readLineBreak(t),
              Tt.call(Kt, r) ? Kt[r](t, r, n) : throwWarning(t, 'unknown document directive "' + r + '"');
          }
          skipSeparationSpace(t, !0, -1),
            0 === t.lineIndent &&
        ...
        var $t = {
          ...
          Jt = ['y', 'Y', 'yes', 'Yes', 'YES', 'on', 'On', 'ON', 'n', 'N', 'no', 'No', 'NO', 'off', 'Off', 'OFF'],
          Qt = /^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;
        function encodeHex(t) {
          ...
          if (((e = t.toString(16).toUpperCase()), t <= 255)) (r = 'x'), (n = 2);
            ...
            if (!(t <= 4294967295)) throw new nt('code point within a string may not be greater than 0xFFFFFFFF');
            (r = 'U'), (n = 8);
          }
            ...
            (this.styleMap = (function compileStyleMap(t, e) {
              ...
              for (r = {}, o = 0, i = (n = Object.keys(e)).length; o < i; o += 1)
                (a = n[o]),
                  ...
                  (u = t.compiledTypeMap.fallback[a]) && Yt.call(u.styleAliases, s) && (s = u.styleAliases[s]),
                  (r[a] = s);
              return r;
          ...
          for (i = 0, a = (o = r ? t.explicitTypes : t.implicitTypes).length; i < a; i += 1)
            if (
              ...
              if (
                ...
                if (((u = t.styleMap[s.tag] || s.defaultStyle), '[object Function]' === Ht.call(s.represent)))
                  n = s.represent(e, u);
                else {
